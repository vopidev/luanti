...
private:
	...
	// far move (teleport) and report them to the server. old_pos is the
	// pre-move position and new_pos the landing position; the jump distance
	// is computed inside (BS-scaled). No-op for moves below the teleport
	// threshold.
